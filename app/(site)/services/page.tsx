...
export default function ServicesPage() {
  return (
    ...
    >
      ...
      <div className="mt-12 flex flex-col items-start justify-between gap-6 rounded-3xl border border-slate-200/70 bg-slate-900 px-8 py-10 text-white md:flex-row md:items-center">
        <div>
